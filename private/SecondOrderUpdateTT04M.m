function [I_ion, S, Sinf, invtau, b, I_Na, I_CaL, I_Kr, I_Ks, I_to, I_K1, I_NaK, I_NaCa] = SecondOrderUpdateTT04M(V, S, Sinf_old, invtau_old, b_old, dt, I_stim, I_stim_old, params)
...
g_Ks = 0.062;         % Maximum conductance of I_Ks (nS/pF)
