function [I_ion, S, Sinf, invtau, b, I_Na, I_CaL, I_Kr, I_Ks, I_to, I_K1, I_NaK, I_NaCa] = SecondOrderUpdateTT3epi(V, S, Sinf_old, invtau_old, b_old, dt, I_stim, I_stim_old, params)
